...
pub fn ticks_around(n_ticks: usize) -> TickData {
    ...
    TickData { ticks, covered_lo: cur - 3 * span, covered_hi: cur + 4 * span - 1, initialized_arrays: vec![cur - span, cur, cur + span], bitmap_extension: None, fetched_at: Instant::now(), layout: flow_trades::quote::clmm::TickLayout::Orca }
}
